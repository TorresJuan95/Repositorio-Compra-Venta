...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2018 a las 20:37:32
...
(1, '2018-01-31', 'F000001', 'luis lopez', '14789', 'juan', 'USD$', '100', '20', '120', 'CHEQUE', '0', 1, 3);
...
(1, 'Juan', 'Torres', '1', '123456', 'juan@gmail.com', 'san jose', '1', 'daniel', 'Qw/*12345678', 'Qw/*12345678', '2017-12-26', '1'),
...
--
ALTER TABLE `usuario_permiso`
  MODIFY `id_usuario_permiso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
